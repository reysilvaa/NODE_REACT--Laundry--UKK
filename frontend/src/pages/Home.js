                ...
                <div class="container-fluid">
                    ...
                    <div class="col-xl-3 col-md-6 mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <div class="col mr-2">
                            <div class="col mr-2">
                                <div class="text-xs font-weight-bold text-info text-uppercase mb-1">Data Paket</div>
                    ...
                    <div class="col-xl-3 col-md-6 mb-4">
                        ...
                        <div class="card-body">
                            <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                <div class="text-xs font-weight-bold text-dark text-uppercase mb-1">Data Outlet</div>
                                <div class="h5 mb-0 font-weight-bold text-gray-800">{this.state.outletCount}</div>
                            </div>
                            <div class="col-auto">
                            <SiHomeassistantcommunitystore opacity={101} size={50} style={{color: "#D1D2E2" }}/>
                            </div>
                            </div>
                        </div>
                        </div>
